...
import com.springboot.common.utils.Function;
import com.springboot.common.utils.ObjectUtils;
import com.springboot.common.utils.PropertiesLoader;
...
class JedisPools{
	//读取配置文件
	private static final PropertiesLoader prop = new PropertiesLoader("application.properties");
	...
	public static JedisPool getPool(){
		if(null ==jedisPool){
			jedisPool= new JedisPool(config,prop.getProperty("redis.host"),Integer.parseInt(prop.getProperty("redis.port")),Integer.parseInt(prop.getProperty("redis.timeout")));
		}
		return jedisPool;
	}
